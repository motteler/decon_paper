...
\documentclass[10pt,twocolumn]{article}  %10pt is big enough with my lucida font
\usepackage{graphicx}
\usepackage{placeins}
\usepackage{url}
...
\begin{figure} % source plot_SRF2.m
  \centering
  \includegraphics[width=\linewidth]{figures/airs_sample_srfs.pdf}
...
\begin{figure} % source slackfigs a2cris_test2.m
  \centering
  \includegraphics[width=\linewidth]{slackfigs/ap_decon_corr.png}
