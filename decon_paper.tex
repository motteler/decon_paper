...
% The residual has a high frequency component with a period of 2
% channel steps that is significantly reduced by the apodization.
% The constant or DC bias is very close to zero for the apodized
% residuals.
